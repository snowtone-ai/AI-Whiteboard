...
| P003 | verified | main | P002 | `apps/extension/src/board/` | Excalidraw board renders as an isolated extension page, self-hosted fonts, exports a white-background PNG plus an ordered structured text summary of drawn elements | unit tests on `summarizeBoard`; manual render check pending | 5 unit tests pass; live-browser render not yet run (see `docs/adapter-smoke.md`) |
